...
# SKRIPT 06: Datenvisualisierung und wissenschaftliche Grafiken
# ==============================================================================
...
# ==============================================================================
# ABBILDUNG 1 (Kapitel 4.2): HÖCHSTE TF-IDF WERTE (Distinktive Kernbegriffe)
# ==============================================================================
if (exists("group_tf_idf")) {
  ...
  plot1 <- ggplot(top_tf_idf, aes(x = reorder_within(word, tf_idf, type), y = tf_idf, fill = type)) +
    geom_col(width = 0.6) +
    scale_x_reordered() +
    coord_flip() +
    ...
    labs(
      title = "Abbildung 1: Die distinktivsten Kernbegriffe der beiden Welten (TF-IDF)",
  ...
  print(plot1)
  ggsave("Visualisations/Abbildung_1_Distinctive_TFIDF.png", plot = plot1, width = 10, height = 6, dpi = 300)
  
} else {
  warning("Objekt 'group_tf_idf' wurde nicht im Workspace gefunden. Abbildung 1 konnte nicht erstellt werden.")
}


# ==============================================================================
# ABBILDUNG 2 (Kapitel 4.2): BILINGUALE WORD CLOUDS
# ==============================================================================
if (exists("tidy_corpus")) {
  png("Visualisations/Abbildung_2_Wordclouds.png", width = 2400, height = 1400, res = 300)
  ...
  dev.off()
  par(mfrow=c(1,1))
  print("Abbildung 2: Wordclouds erfolgreich unter 'Abbildung_2_Wordclouds.png' gespeichert.")
}


# ==============================================================================
# ABBILDUNG 3 (Kapitel 4.3): ISOMORPHISM GRADIENT (Ranking aller Start-ups)
# ==============================================================================
plot3 <- ggplot(iso_index_data, aes(x = reorder(startup, cosine_similarity), y = cosine_similarity)) +
  geom_col(width = 0.7, fill = "#27ae60") +
  coord_flip() +
  labs(
    title = "Abbildung 3: Mimetic Isomorphism Index",
...
print(plot3)
ggsave("Visualisations/Abbildung_3_Isomorphism_Gradient.png", plot = plot3, width = 9, height = 8, dpi = 300)


# ==============================================================================
# ABBILDUNG 4 (Kapitel 4.3): VERTEILUNGSDICHTE
# ==============================================================================
plot4 <- ggplot(iso_index_data, aes(x = cosine_similarity)) +
  ...
  labs(
    title = "Abbildung 4: Verteilungsdichte der mimetischen Isomorphie",
...
print(plot4)
ggsave("Visualisations/Abbildung_4_Isomorphism_Density.png", plot = plot4, width = 8, height = 5, dpi = 300)


# ==============================================================================
# ABBILDUNG 5 (Kapitel 4.4): STRATEGIC GAP (Aggregierte Entkopplung)
# ==============================================================================
plot5 <- ggplot(gap_data, aes(x = type, y = share, fill = category)) +
  ...
  labs(
    title = "Abbildung 5: Strategic Decoupling vs. Technical Substance",
    subtitle = "Vergleich des linguistischen Fokus von etablierten Unternehmen vs. Start-ups",
    y = "Vokabular-Anteil (%)", 
    x = "Organisationstyp",
...
print(plot5)
ggsave("Visualisations/Abbildung_5_Strategic_Gap.png", plot = plot5, width = 8, height = 6, dpi = 300)


# ==============================================================================
# ABBILDUNG 6 (Kapitel 4.4): TOP INSTITUTIONAL KEYWORDS
# ==============================================================================
if (exists("tidy_corpus") & exists("sustainability_dict")) {
  ...
  plot6 <- ggplot(top_shared_words, aes(x = reorder_within(word, n, type), y = n, color = type)) +
    geom_point(size = 3.5) +
    ...
    labs(
      title = "Abbildung 6: Use of Institutional Keywords",
  ...
  print(plot6)
  ggsave("Visualisations/Abbildung_6_Top_Keywords.png", plot = plot6, width = 10, height = 6, dpi = 300)
}


# ==============================================================================
# ABBILDUNG 7 (Kapitel 4.5): BOXPLOT - Technische Substanz nach Organisationstyp
# ==============================================================================
if (exists("firm_decoupling")) {
  
  plot7 <- ggplot(firm_decoupling, aes(x = type, y = technical_substance_share, fill = type)) +
    geom_boxplot(width = 0.5, alpha = 0.8, outlier.shape = NA) +
    geom_jitter(width = 0.1, size = 2, alpha = 0.6, color = "black") +
    scale_fill_manual(values = c("Incumbent" = "#2c3e50", "Startup" = "#27ae60")) +
    labs(
      title = "Abbildung 7: Technische Substanz nach Organisationstyp",
  ...
  print(plot7)
  ggsave("Visualisations/Abbildung_7_Boxplot_Substance.png", plot = plot7, width = 7, height = 6, dpi = 300)
  
} else {
  warning("Objekt 'firm_decoupling' wurde nicht im Workspace gefunden. Abbildung 7 konnte nicht erstellt werden.")
}


# ==============================================================================
# ABBILDUNG 8 (Kapitel 4.6): SCATTERPLOT (Isomorphie x technische Substanz)
# ==============================================================================
correlation_data <- iso_index_data %>%
  left_join(firm_decoupling, by = c("startup" = "name"))

plot8 <- ggplot(correlation_data, aes(x = cosine_similarity, y = technical_substance_share)) +
  ...
  labs(
    title = "Abbildung 8: Das Spannungsfeld zwischen Fassade und Substanz auf Mikro-Ebene",
...
print(plot8)
ggsave("Visualisations/Abbildung_8_Decoupling_Micro_Scatter.png", plot = plot8, width = 9, height = 7, dpi = 300)